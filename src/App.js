...
const images = [
  ...
  },
  {
    img: smith_morehouse,
    text:
      'We had so many fun summer activities like this one. You are my #1 adventure partner.',
  },
  {
    ...
    (() => {
      ...
      k(
        '@keyframes m{0%{margin-top:2vh;opacity:0;}20%{opacity:1.0;margin-top:0vh;margin-left:0vw;transform:rotate(' +
          d(360) +
          'deg);}100%{opacity:0.2;margin-top:100vh;margin-left:' +
          d(4) +
      ...
      while (h--) {
        ...
        o.style = `pointer-events:none;opacity:0;animation:m ${d(14) +
          6}s ease-in ${d(4000)}ms infinite;z-index:1000;position:fixed;top:${d(
          40,
        )}vh;left:${d(100)}vw;font-size:${d(50) + 10}px;`;
        o.innerHTML = ['❤️', '💚', '💛', '💙', '💜'][d(5)];
        w.appendChild(o);
      }
    })();
